...
const InputControlDial = memo(function InputControlDial({
  ...
  return (
    <View style={dynamicStyles.container}>
      <Text style={[dynamicStyles.label, { color: theme.theme.colors.text.primary }]}>{label}</Text>
      <View style={dynamicStyles.dialControls}>
        ...
        <View style={dynamicStyles.dialValueWrapper}>
          <TextInput
            ...
            maxLength={5}
          />
          <Text style={[dynamicStyles.dialUnit, { color: theme.theme.colors.text.secondary }]}>
            {unit}
          </Text>
        </View>
