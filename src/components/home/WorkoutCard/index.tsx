 ...
 */
export const WorkoutCard = ({ workout, loading, onStart, onConfigure }: WorkoutCardProps) => {
  const { theme } = useTheme()

  return (
    <Animated.View
      entering={FadeInDown.duration(ANIMATION_DURATION).delay(ANIMATION_DELAYS.workout)}
    ...
    >
      <View style={styles.workoutHeader}>
        ...
        <View style={styles.workoutBadge}>
          <View style={[styles.badgeDot, { backgroundColor: theme.colors.success[500] }]} />
